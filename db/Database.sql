...
CREATE TABLE IF NOT EXISTS 'sensores' (
    ...
    `tipo_sensor` ENUM('Ultrassonico', 'LDR (luminosidade)', 'Sensor DHT11') NOT NULL DEFAULT NULL,
    ...
    'Trilho 5-Sul', 'Trilho 5-Norte', 'Trilho 6-Sul', 'Trilho 6-Norte')  NOT NULL DEFAULT NULL,
