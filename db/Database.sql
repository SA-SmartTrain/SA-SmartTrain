...
CREATE TABLE IF NOT EXISTS sensores (
    ...
    localizacao_sensor ENUM(
        'Trilho 1-Sul', 'Trilho 1-Norte',
        'Trilho 2-Sul', 'Trilho 2-Norte',
        'Trilho 3-Sul', 'Trilho 3-Norte',
        'Trilho 4-Sul', 'Trilho 4-Norte',
        'Trilho 5-Sul', 'Trilho 5-Norte',
        'Trilho 6-Sul', 'Trilho 6-Norte'
    ) NOT NULL,
